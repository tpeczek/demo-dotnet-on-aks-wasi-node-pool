...
void http_handler_error_free(http_handler_error_t *ptr) {
  switch ((int32_t) ptr->tag) {
    case 0: {
      http_handler_string_free(&ptr->val.error_with_description);
      break;
    }
  }
}
void http_handler_expected_response_error_free(http_handler_expected_response_error_t *ptr) {
  if (!ptr->is_err) {
    ...
    http_handler_error_free(&ptr->val.err);
  }
}
...
int32_t __wasm_export_http_handler_handle_http(int32_t arg, int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7, int32_t arg8) {
  ...
  http_handler_expected_response_error_t ret;
  http_handler_handle_http(&arg9, &ret);
  int32_t ptr = (int32_t) &RET_AREA;
  
  if ((ret).is_err) {
    const http_handler_error_t *payload14 = &(ret).val.err;
    *((int8_t*)(ptr + 0)) = 1;
    switch ((int32_t) (*payload14).tag) {
      case 0: {
        const http_handler_string_t *payload15 = &(*payload14).val.error_with_description;
        *((int8_t*)(ptr + 4)) = 0;
